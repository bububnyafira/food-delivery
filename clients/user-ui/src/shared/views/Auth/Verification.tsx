      ...
      <div className="m-auto flex items-center justify-around">
        {Object.keys(verifyNumber).map((key, index) => (
          <input
            ...
            key={key}
            ref={inputRefs[index]}
            className={`w-[65px] h-[65px] bg bg-transparent border-[3px] rounded-xl flex items-center text-white justify-center text-[18px] font-Poppins outline-none text-center ${
